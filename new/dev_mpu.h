...
struct mpu_dev {
	...
	struct	mpu_ang	*ang;	/* calibration data */
...
struct mpu_ang {
	long double Rx_earth;	/* x-axis angle relative to tangent plane */
	long double Ry_earth;	/* y-axis angle relative to tangent plane */
	long double Rz_earth;	/* yaw relative to starting position */
	long double Ro_earth;	/* tilt angle relative to tangent plane */
};
